    ...
    <div class='dialog-container' v-show="isShow">
      ...
      <div class="dialog-box" :style="styles">
        ...
        <div class="dialog-header" v-if="showHeader">
          ...
          <svg class="el-icon-close" v-if="showClose" @click="onClose" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#f38181" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
